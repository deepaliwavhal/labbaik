            ...
            <div class="sidebar">
                ...
                <nav class="sidebar-inner collapse navbar-collapse bs-navbar-collapse2" role="navigation" style="padding:0;">
                    <ul class="navi">
                        ...
                        <li class="has_submenu nlightblue"> <a class="mm_package_control" href="#"> <i class="fa fa-file-text"></i> 
                        <?= lang('package_control'); ?> <span class="pull-right"><b class="fa fa-sort-down"></b></span> </a>
                            <ul>
                                <li><a id="package_control_index" href="<?= site_url('package_control'); ?>"><?= lang('package_control'); ?></a></li>
                                <li><a id="title_of_trips_group" href="<?= site_url(); ?>"><?= lang('title_of_trips_group'); ?></a></li>
                                <li class="divider"></li>
                                <li><a id="reservation" href="<?= site_url(); ?>"><?= lang('reservation'); ?></a></li>
                                <li><a id="rooming" href="<?= site_url(); ?>"><?= lang('rooming'); ?></a></li>
                            </ul>
                        </li>
                        <li class="has_submenu nlightblue"> <a class="mm_sales" href="#"> <i class="fa fa-file-text"></i> 
                                <?= lang('sales'); ?> <span class="pull-right"><b class="fa fa-sort-down"></b></span> </a>
                            <ul>
