...
@media only screen and (max-width: 760px), (min-device-width: 768px) and (max-device-width: 1024px)  {
    ...
    #dyTable tbody td:nth-of-type(2):before { content: "<?= lang('gender'); ?>"; }
...
<div class="matter">
    <div class="container">
        <?php $attrib = array('class' => 'form-horizontal'); echo form_open("trips_order/add");?>

        <?php include('form.php'); ?>

        <div class="form-group">
            <?= form_submit('submit', lang("add_trip_order"), 'class="btn btn-primary btn-lg"');?>
        </div>
        <?= form_close();?>
