...
class Trips_Order extends MY_Controller {
	...
	{            
		...
		$this->load->model('trips_order_model');
	...
	function index()
	{
            ...
            $this->data['page_title'] = $this->lang->line("trips_order");
            $this->data['customers'] = $this->sales_model->getAllCustomers();
            $this->data['gender']=array("F"=>"Female", "M"=>"male");
            $this->data['traveler_type']=array("1"=>"Adult", "2"=>"Child", "3"=>"Infant");
            $this->data['packages'] = $this->trips_model->getAllTrips();
            //$this->data['total'] = $this->trips_order_model->getTotal(); 
//            echo "<pre>";
...
//            exit;
		...
		$this->page_construct('home', $this->data);*/
                $this->page_construct('trips_order/index', $this->data);
